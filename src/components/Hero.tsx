      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
            <span className="gradientText">Hello </span>there,
            <br />
            My name is Darvin
          </h1>
          ...
          >
            Get started
            <svg
              className="w-5 h-5 ml-2 -mr-1 hover:rotate-45 transition-transform"
              fill="currentColor"
              viewBox="0 0 20 20"
        ...
        <div className="hidden lg:mt-0 rounded-lg  overflow-hidden lg:col-span-5 lg:flex">
          <img src={SE} alt="mockup" />
        </div>
      </div>
    </section>
  );
